	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnOK) {
			...
			if (controller.crearJugador(user, password, dorsal, numGoles, numAsist, myTeam)) {
	            JOptionPane.showMessageDialog(this, "El jugador se ha añadido correctamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
	            clearFields();
...
//					g1.setVisible(true);
	            ...
	            JOptionPane.showMessageDialog(this,"Error al añadir el jugador(Ya existe). Por favor, inténtelo de nuevo.", "Error", JOptionPane.INFORMATION_MESSAGE);
	        }
    ...
    private void clearFields() {
		...
		textFieldDorsal.setSelectedIndex(-1);
    }
}